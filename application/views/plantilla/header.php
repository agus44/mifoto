...
<html lang="en">
  <head>
    ...
    <script src="<?php echo base_url();?>js/sweet-alert.js"></script>
    <script src="<?php echo base_url();?>js/bootstrap-datepicker.js"></script>
    <script src="<?php echo base_url();?>js/jquery.Rut.js"></script>
    <script src="<?php echo base_url();?>js/jquery.Rut.min.js"></script>
    <script src="<?php echo base_url();?>js/validate.js"></script>
    <script src="<?php echo base_url();?>js/funciones.js"></script>
    
   
                <div class="div-nuevo" class="col-xs-12">   
                   <img src="<?php echo base_url() ?>images/logo.png" width="200" height="60">
